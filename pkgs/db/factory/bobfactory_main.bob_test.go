...
func TestCreateDeviceLocation(t *testing.T) {
	if testDB == nil {
	...
	if _, err := New().NewDeviceLocationWithContext(ctx).Create(ctx, tx); err != nil {
		t.Fatalf("Error creating DeviceLocation: %v", err)
	}
}
